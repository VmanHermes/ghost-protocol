  ...
  return (
    <div className="chat-renderer">
      ...
      <div className="chat-composer">
        <textarea ref={textareaRef} className="chat-input" value={draft} onChange={(e) => setDraft(e.target.value)} onKeyDown={handleKeyDown} placeholder="Send a message..." rows={1} />
        <button className="btn-primary chat-send-btn" onClick={handleSend} disabled={!draft.trim()}>Send</button>
      </div>
    </div>
  );
}
